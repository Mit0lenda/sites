      ...
      <div className="privacy-card">
        ...
        <div className="privacy-content">
          <p className="privacy-intro">
            These terms and conditions apply to the BoyBoy app (hereby referred to as "Application") 
            for mobile devices that was created by Daltro's LLC (hereby referred to as "Service Provider") 
          ...
          <p>
            ...
            As such, they reserve the right to modify the Application or charge for their services at any time and for 
            any reason. The Service Provider assures you that any charges for the Application or its services will be 
          ...
          <p>
            ...
            to provide the Service. It is your responsibility to maintain the security of your phone and access to 
            the Application. The Service Provider strongly advise against jailbreaking or rooting your phone, which 
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                <a href="https://godotengine.org/license" target="_blank" rel="noopener noreferrer">Godot</a>
              </li>
            </ul>
          </section>
          ...
          <p>
            ...
            agreement terms still apply. Consequently, you may incur charges from your mobile provider for data usage 
            during the connection to the application, or other third-party charges. By using the application, you accept 
          ...
          <p>
            ...
            it is your responsibility to ensure that your device remains charged. If your device runs out of battery and 
            you are unable to access the Service, the Service Provider cannot be held responsible.
          </p>
          ...
          <p>
            The Service Provider may wish to update the application at some point. The application is currently available 
            as per the requirements for the operating system (and for any additional systems they decide to extend the 
            ...
            without providing termination notice to you. Unless they inform you otherwise, upon any termination, 
          ...
          <p className="effective-date">These terms and conditions are effective as of 2026-05-13</p>

          <section>
            <h2>Contact Us</h2>
            <p>
              If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact 
              the Service Provider at <a href="mailto:zubarev1@daltrollc.com">zubarev1@daltrollc.com</a>.
            </p>
          </section>

          <hr className="privacy-divider" />
          <p className="generator-link">
